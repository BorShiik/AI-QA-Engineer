...
├── ai_qa_agent.py     # Main Python script hosting the AI Agent pipeline
├── README.md          # Project documentation and setup guide
└── target_file.py     # Your source code file to analyze (e.g., prANS480.py)
...
python ai_qa_agent.py path/to/your/code.py
...
The terminal prints a detailed, itemized Code Review in Polish.

A brand-new testing script named test_prANS480.py is automatically compiled and saved in the identical directory.
